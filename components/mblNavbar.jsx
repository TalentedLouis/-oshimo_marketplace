...
const MblNavbar = ({ theme }) => {
  ...
  //   if(!account) return
  //   // const balance = await useEtherBalance(account)
  //   // console.log(balance);
		...
		>
				...
				<ul className="flex flex-col lg:flex-row">
					...
					<li className="js-nav-dropdown nav-item dropdown group relative">
						<button
							...
							onClick={(e) => handleItemDropdown(e)}
						>
							<span className={navText === 'collection' ? 'text-accent' : ''}>Explore</span>
					...
					<li className="js-nav-dropdown group relative">
						<button
							...
							onClick={(e) => handleItemDropdown(e)}
						>
							<span className={navText === 'resources' ? 'text-accent' : ''}>Resources</span>
					...
					<li className="group">
						<Link href="/create">
							...
							>
								...
								>
									<span className={navText === 'create' ? 'text-accent' : ''}>Create</span>
								</button>
							</a>
						</Link>
					</li>
				...
				<div className="js-nav-dropdown group-dropdown relative">
					...
					>
						<UserId
							...
							userId={account ? account : "not connected"}
							shortId={true}
						/>
            <div className="dark:border-jacarta-600 border-jacarta-100 mx-5 mb-6 rounded-lg border p-4">
              ...
              <div className="flex items-center">
                ...
                <span className="text-green text-lg font-bold">{etherBalance ? etherBalance : 'loading...'}</span>
              </div>
            </div>
